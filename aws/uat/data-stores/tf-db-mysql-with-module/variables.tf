...
variable "tf_uat_db_mysql_prefix" {
  description = "Name of the Identifier Prefix for out AWS DB Instance"
  type        = string
  default     = "tf-uat-db-mysql-prefix"
}

# DB Engine to use
variable "tf_uat_db_mysql_engine" {
...
variable "tf_uat_db_mysql_allocated_storage" {
...
variable "tf_uat_db_mysql_instance_class" {
...
variable "tf_uat_db_mysql_db_name" {
...
# DB User Name
variable "tf_uat_db_username" {
  description = "Username for the UAT DB"
  type        = string
  sensitive   = true
}

# DB Password
variable "tf_uat_db_password" {
  description = "Password for the UAT DB"
  type        = string
  sensitive   = true
}